...
int main()
{
    ...
    if (powerManager.initialize()) {
        ...
        std::cerr << "Power Manager initialization failed." << std::endl;
    }
    ...
    while(true) {
        ...
        if (currentTime - lastPrintTime > 1000) {
            printSensorData(lightLevel, temperature, humidity, pressure, magnetic_1, magnetic_2, magnetic_3);
